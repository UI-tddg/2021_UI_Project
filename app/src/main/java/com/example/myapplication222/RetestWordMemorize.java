...
public class RetestWordMemorize extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        korText.setText(RetestSellect.retestarr[current][1]);
        showWord.setText(RetestSellect.retestarr[current][2]);
        speaker.setText(RetestSellect.retestarr[current][3]);
        current++;
    }
